Step 1 : Select "Empty Activity" Sign in google account in both android studio and firebase...minimum sdk either 34 or 35...if not available then we can change in graddle(app) then sync
